...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/main.css">   <!--External style sheet -->
    ...
    <script src="courses.js" type="text/javascript"></script> <!-- External js file-->
      ...
      <nav style="background-color: #00223d;" class="navbar navbar-expand-sm navbar-dark coursenav">
       <button class="w3-button w3-xlarge w3-hide-large w3-left w3-hover-text-white w3-hover-none w3-border-0" id="btnmize" onclick="w3_open()">&#9776;</button>
        <a class="navbar-brand sty1" href="index.php">
            <img src="image/logo.PNG" alt="Logo" style="width:130px;">
        </a>
...
<h1>testttt</h1>
        ...
        <!-- MOdal Ends-->
          ...
          <div class="firstacc mb-4">
            ...
            <!--  <div id="loader"><img id="loading-image" src="image/loader.gif" alt="Loading..." /></div>--><!-- loader untill results of the datatable get loaded-->
        ...
        <?php
                                      ...
                                      $records = "SELECT SBGI_CODE,CRSE_NUMB_FROM_SCHOOL, SUBJ_CODE_FROM_SCHOOL, CRSE_TITLE_FROM_SCHOOL, SHBTATC_CREDITS_FROM_SCHOOL, CONNECTOR_COL_ODU, CRSE_NUMB_INST_ODU, SUBJ_CODE_INST_ODU, INST_TITLE_ODU FROM V_WX_EQUIVALENCY_LIST WHERE SBGI_CODE ='".$_POST['school_state']."' ORDER BY SUBJ_CODE_FROM_SCHOOL ASC";
                                  ...
                                  //  var_dump($rec);
                                     // while($row = oci_fetch_array($result, OCI_ASSOC+OCI_RETURN_NULLS)){
                                        foreach($rec as $row){
                                      echo "hello here at 340";
                                      print_r($row);
                                     //echo "<table>";
                                     echo "<tr>";
                                     echo "hello here at 340";
                                     // echo "<td>hello</td>";
                                    //  echo "<td>" . $row['SUBJ_CODE_FROM_SCHOOL'] ." ". $row['CRSE_NUMB_FROM_SCHOOL'] . "</td>";
                                     // echo "<td>" . $row['CRSE_TITLE_FROM_SCHOOL'] . "</td>";
                                     // echo "<td>" . $row['SHBTATC_CREDITS_FROM_SCHOOL'] . "</td>";
                                     // echo "<td>" . $row['SUBJ_CODE_INST_ODU']." ". $row['CRSE_NUMB_INST_ODU'] . "</td>";
